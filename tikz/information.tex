\begin{tikzpicture}[first style/.style={rectangle, rounded corners}, steuer style/.style={draw, rectangle, text width=2.8cm, align=center}]
	...
	\node[first style, ultra thick] (P1) at (-4, 5){Physik};
	\node[first style, ultra thick] (P2) at (0, 5){Physiologie};
	\node[first style, right=of P2, ultra thick] (P3) at (4, 5) {Psychologie};
