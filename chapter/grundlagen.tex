...
%TODO Schärfe des Auges berechnen, ab wann Pixel sichtbar sind%
...
%TODO Tikz zu den einzelnen Wahrnehmungsarten machen%
...
%TODO Abbildung von EInteilung Düfte einfügen%
...
Im folgenden werden die gängigen Bussysteme in der Fahrzeugtechnik vorgestellt. Zuerst werden die draht-gebundenen und danach die drahtlosen Techniken erläutert. Im Anschluss erfolgt ein Vergleich zwischen den Merkmalen der einzelnen Bussysteme.
\subsection{Controller Area Network (CAN \nomenclature{CAN}{Controller Area Network})}
CAN wird zum Austausch von Mess-, Steuer- und Regelsignalen genutzt. Es ist ein bitstrom-orientiertes System. Es basiert auf Differenzsignalübertragung und benutzt dazu verdrillte Leiterpaare. Es ist ein ereignisgesteuertes System, das heißt eine Nachricht wird durch ein Ereignis gesendet. \\
...
\paragraph{Performance}
Für Botschaften mit acht Byte Nutzdaten werden Sendezeitraster von 10 ms benötigt. \cite[Vgl. Seite 94 f.]{Zimmermann.2014} Die Nutzdatenmenge beträgt dementsprechend ca. $ 800\,\frac{\mathrm{Byte}}{s} $.
\subsection{FlexRay}
...
\paragraph{Performance}
Die Nutzdatenmenge beträgt je nach Bitrate $ X\,\frac{\mathrm{Byte}}{\mathrm{s}} $
...
\paragraph{Performance}
Es sind bis zu 1500 Byte Nutzdaten pro Frame möglich. Es ergibt sich eine maximal mögliche Nutzdatenmenge von $ X\,\frac{\mathrm{MByte}}{\mathrm{s}} $. \cite[Vgl. Seite 138 ff.]{Zimmermann.2014}
\subsection{Wireless Local Area Network (WLAN\nomenclature{WLAN}{Wireless Local Area Network})}
WLAN ist ein drahtloser Kommunikationsstandard.
...
\begin{table}[hbt]	
	...
	\begin{tabular}{c|ccccccc}
		 & \parbox[t]{0.2\linewidth}{\centering CAN} & \parbox[t]{0.2\linewidth}{\centering LIN} & \parbox[t]{0.2\linewidth}{\centering FlexRay} & \parbox[t]{0.2\linewidth}{\centering MOST} & \parbox[t]{0.2\linewidth}{\centering Automotive Ethernet}  & \parbox[t]{0.2\linewidth}{\centering WLAN} & \parbox[t]{0.2\linewidth}{\centering Bluetooth}\\ 
		\hline 
		\hline 
		Funktionsweise &&&&&&& \\
		Bittakt &&&&&&& \\
