...
\begin{table}[hbt]	
	...
	\label{tab:Werte}
	\begin{tabular}{c|cc}
		\textbf{Komponente} & \parbox[t]{0.18\linewidth}{\centering Speicher pro Bild} & \parbox[t]{0.18\linewidth}{\centering Speichergröße gesamt} \\ 
		\hline 
		\hline 
		...
		\parbox[t]{0.3\linewidth}{\centering LED-Streifen in der Frontschürze} & $ 996\,\mathrm{Byte} $ & $ 11,952\,\mathrm{MByte} $ \\
		\parbox[t]{0.3\linewidth}{\centering LED-Streifen in den Radkästen} & $ 600\,\mathrm{Byte} $ & $ 7,2\,\mathrm{MByte} $ \\ 
		\parbox[t]{0.3\linewidth}{\centering LED-Streifen in der Heckleuchte} & $ 1,173\,\mathrm{kByte} $ & $ 14,076\,\mathrm{MByte} $ \\ 
		\parbox[t]{0.3\linewidth}{\centering LED-Streifen im Interieur} & $ 2,157\,\mathrm{kByte} $ & $ 25,884\,\mathrm{MByte} $ \\
		\parbox[t]{0.3\linewidth}{\centering LED Türtafeln} & $ 12\,\mathrm{Byte} $ & $ 144\,\mathrm{KByte} $ \\
		\parbox[t]{0.3\linewidth}{\centering Videoprojektoren in\\den Außenspiegeln} & $ 307,2\,\mathrm{kByte} $ & $ 3,6864\,\mathrm{GByte} $ \\ 
		\parbox[t]{0.3\linewidth}{\centering Videoprojektoren im Fußraum} & $ 307,2\,\mathrm{kByte} $ & $ 3,6864\,\mathrm{GByte} $ \\
		\parbox[t]{0.3\linewidth}{\centering Bildschirme in den\\hinteren Seitenfenstern} & $ 307,2\,\mathrm{kByte} $ & $ 3,6864\,\mathrm{GByte} $ \\
		\parbox[t]{0.3\linewidth}{\centering Bildschirme in der Einstiegsleiste} & $ 393,216\,\mathrm{kByte} $ & $ 4,718592\,\mathrm{GByte} $ \\
		\parbox[t]{0.3\linewidth}{\centering Durchsichtiger Bildschirm\\im Dachfenster} & $ 207,36\,\mathrm{kByte} $ & $ 2,48832\,\mathrm{GByte} $ \\
		\parbox[t]{0.3\linewidth}{\centering LED-Matrix im Dachhimmel} & $ 55,296\,\mathrm{kByte} $ & $ 663,552\,\mathrm{MByte} $ \\
		\parbox[t]{0.3\linewidth}{\centering Morphende Oberfläche\\in der Mittelkonsole} & $ 400\,\mathrm{Byte} $ & $ 4,8\,\mathrm{MByte} $ \\
	\end{tabular} 
\end{table}
