...
\addbibresource{literature/literatur4.bib} %be4gjkbrtj r4 ju%
...
\newcommand{\arbeit}{Projektarbeit T3\_2000}
...
\pgfplotsset{
	every axis/.append style={grid, width=1\textwidth, height=10cm},
	grid style={densely dotted, thick},
	label style={font=\small},	
	legend pos={outer north east},
	cycle list={red, green, cyan, yellow}
}
...
\hyphenation{Steuer-botschaften}
...
\printnomenclature
\cleardoublepage
\listoffigures				% Erzeugen des Abkürzungsverzeichnises, siehe auch Inhalt der Datei pages/abkuerzungen.tex
\cleardoublepage
%\renewcommand{\glossaryname}{Glossar}
%\printglossaries
%\cleardoubles 							% Erzeugen des Abbildungsverzeichnisses 
\cleardoublepage
