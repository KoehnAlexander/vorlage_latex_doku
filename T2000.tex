...
\newcommand{\titel}{Technische Bewertung der Komponenten eines bestehenden Fahrzeugprototypen auf Basis der Realisierungsmöglichkeiten für eine Serienentwicklung}
...
\include{chapter/kriterien}
\include{chapter/analyse}
\include{chapter/konzeptentwurf}
\include{chapter/systementwurf}
